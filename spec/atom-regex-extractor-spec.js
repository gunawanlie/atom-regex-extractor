...
import AtomRegexExtractor from '../lib/atom-regex-extractor';
...
describe('AtomRegexExtractor', () => {
  let workspaceElement, activationPromise;

  beforeEach(() => {
    workspaceElement = atom.views.getView(atom.workspace);
    activationPromise = atom.packages.activatePackage('atom-regex-extractor');
  });

  describe('when the atom-regex-extractor:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.atom-regex-extractor')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.atom-regex-extractor')).toExist();

        let atomRegexExtractorElement = workspaceElement.querySelector('.atom-regex-extractor');
        expect(atomRegexExtractorElement).toExist();
